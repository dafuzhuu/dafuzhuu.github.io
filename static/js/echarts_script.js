...
const dates = ['2024-04-01', '2024-04-02', '2024-04-03', '2024-04-08'];
const data_factor = [1.64, 1.93, 1.15, -0.86];
const data_etf = [0.57, 0.08, 1.40, 2.35];
const data_1A0300 = [1.64, -0.42, -0.36, -0.88];
const data_1A0001 = [1.19, -0.08, -0.18, -0.72];
const data_004685 = [1.82, 0.28, 0.41, -1.23];
